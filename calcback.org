...
#+BEGIN_SRC python :results output :tangle yes
  ...
  rho_L = calc_rho(rs_al, rp_al, rs_ls, rp_ls, d_L, n_L, phi_L, lambda_vac, returnbeta=False)
#+END_SRC
...
rho_L = calc_rho(rs_al, rp_al, rs_ls, rp_ls, d_L, n_L, lambda_vac)
  ...
  #+BEGIN_SRC python :export both :results value  
    rhotest, betatest = calc_rho(rs_altest, rp_altest, rs_lstest, rp_lstest, 300, n_L[0], phi_Ltest, lambda_vac, returnbeta=True)
    betatest
  #+END_SRC
